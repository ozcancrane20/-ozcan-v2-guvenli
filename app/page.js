...
import { Package, AlertTriangle, ShoppingCart, TrendingUp, DollarSign, Activity, LogOut, Eye, EyeOff } from 'lucide-react';
...
export default function Home() {
  ...
  const [dashboardData] = useState({
    ...
    todayMovements: 24,
    totalValue: 456780,
    weekActivity: [45, 52, 48, 61, 58, 67, 73]
  });
  ...
  // SAYFA YENİLENİNCE KULLANICI VE VERİLERİ YÜKLE
  useEffect(() => {
  ...
  // İKİ SEKME ARASINDA SENKRONİZASYON
  useEffect(() => {
